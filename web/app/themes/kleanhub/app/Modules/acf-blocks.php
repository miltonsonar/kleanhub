    ...
    foreach ($directories as $directory) {
        ...
        foreach ($template_directory as $template) {
            if (! $template->isDot() && ! $template->isDir()) {
                ...
                $file = "{$dir}/{$slug}.blade.php";  // Corrected variable interpolation
                ...
                if (! empty($file_headers['supports_mode'])) {
                    $data['supports']['mode'] = $file_headers['supports_mode'] === 'true' ? 'auto' : 'editor';
                }
                ...
                if (! empty($file_headers['preview'])) {
                    $data['preview'] = get_template_directory_uri().'/resources/images/previews/'.$file_headers['preview'].'.jpg';
                }
